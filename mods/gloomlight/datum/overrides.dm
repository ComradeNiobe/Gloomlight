/decl/species
	available_background_info = list(
		...
		/decl/background_category/homeworld = list(
			/decl/background_detail/location/gloomlight,
			/decl/background_detail/location/other
		),
		/decl/background_category/faction =   list(
			/decl/background_detail/faction/gloomlight,
			/decl/background_detail/faction/other
		),
		/decl/background_category/heritage =   list(
			/decl/background_detail/heritage/gloomlight,
			/decl/background_detail/heritage/gloomlight/byzantine_empire,
	...
	default_background_info = list(
		...
		/decl/background_category/homeworld   = /decl/background_detail/location/gloomlight,
		/decl/background_category/faction     = /decl/background_detail/faction/gloomlight,
		/decl/background_category/heritage    = /decl/background_detail/heritage/gloomlight,
